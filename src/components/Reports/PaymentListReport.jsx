...
import { getallPaymentDetails } from '../../Services/data.services';

const PaymentListReport = ({ goToReports }) => {
    ...
    const fetchPaymentDetails = async () => {
      ...
      try {
        ...
        if (response.data && Array.isArray(response.data)) {
          ...
          const filteredPayments = payments.filter((payment) => payment.pending > 0);
  ...
  return (
    <div style={{ marginTop: '-25px' , marginLeft: '-15px', marginRight: '-25px'}}>
      <style>
        {`
          .ant-table {
            width: 100%;
      ...
      <Typography.Title level={3}>Payment List</Typography.Title>
...
export default PaymentListReport;
